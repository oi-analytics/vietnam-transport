...
def main():
    ...
    data_excel = os.path.join(hazard_intersections_path, 'hazard_scenarios',
    ...
    for province in provinces:
        ...
        intersection_dir = os.path.join(
            hazard_intersections_path, '{}_roads_hazard_intersections'.format(province_name))
                ...
                if file.endswith(".shp"):
                    ...
                    if str(band_type) == 'True':
                        hazard_dict['band_num'] = [
                            b for b in bnds if '{}_band'.format(b) in file][0]
                    ...
                    data_dict = spatial_scenario_selection(
                        hazard_shp, commune_shp, province, hazard_dict, data_dict)
