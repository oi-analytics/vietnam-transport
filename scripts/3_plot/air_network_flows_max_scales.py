...
def main():
    config = load_config()
    air_edge_file = os.path.join(config['paths']['data'], 'Results', 'Flow_shapefiles', 'weighted_edges_flows_national_air.shp')
    ...
    for c in range(len(columns)):
        ...
        output_file = os.path.join(config['paths']['figures'], 'air_flow-map-{}-max-scale.png'.format(column))
